...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_properties_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    ...
    var _hotel_card_hotel_card_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./hotel-card/hotel-card.component */
    "./src/app/hotel-card/hotel-card.component.ts");

    function AppComponent_agm_marker_3_Template(rf, ctx) {
      if (rf & 1) {
        var _r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "agm-marker", 4);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("markerClick", function AppComponent_agm_marker_3_Template_agm_marker_markerClick_0_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r4);

          var ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r3.onMarkerClick($event);
        });
    ...
    function AppComponent_app_hotel_card_4_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function () {
      ...
      _createClass(AppComponent, [{
        ...
        key: "getHotels",
        value: function getHotels(latitude, longitude) {
          var _this = this;

          this.service.get(latitude, longitude, "hotel").subscribe(function (response) {
            // this.hotels = [];
            var results = response.results.filter(function (item) {
              return item.position;
            });
            results.forEach(function (element) {
              if (!_this.hotels.map(function (hotel) {
                return hotel.id;
              }).includes(element.id)) {
                var hotel = {
                  id: element.id,
                  ...
                  description: "".concat(element.distance, " from the city center."),
        ...
        value: function onMarkerClick(event) {
          ...
          var clickedHotel = this.hotels.find(function (hotel) {
            return hotel.latitude == latitude && hotel.longitude == longitude;
          });
        ...
        value: function onMapReady(map) {
          ...
          map.addListener('dragend', function () {
            ...
            _this2.getHotels(latitude, longitude);
          });
        }
      }]);
    ...
    AppComponent.ɵfac = function AppComponent_Factory(t) {
      return new (t || AppComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_properties_service__WEBPACK_IMPORTED_MODULE_1__["PropertiesService"]));
    };
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 5,
      vars: 8,
      consts: [[1, "container"], [3, "latitude", "longitude", "zoomControl", "minZoom", "mapClick", "mapReady"], [3, "latitude", "longitude", "iconUrl", "markerClick", 4, "ngFor", "ngForOf"], [3, "hotel", 4, "ngIf"], [3, "latitude", "longitude", "iconUrl", "markerClick"], [3, "hotel"]],
      template: function AppComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("mapClick", function AppComponent_Template_agm_map_mapClick_2_listener($event) {
            return ctx.onMapClick($event);
          })("mapReady", function AppComponent_Template_agm_map_mapReady_2_listener($event) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AppComponent, [{
        ...
        return [{
          type: _services_properties_service__WEBPACK_IMPORTED_MODULE_1__["PropertiesService"]
        }];
      }, null);
    })();
    /***/
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _hotel_card_hotel_card_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./hotel-card/hotel-card.component */
    "./src/app/hotel-card/hotel-card.component.ts");
    /* harmony import */


    var _services_properties_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./services/properties.service */
    "./src/app/services/properties.service.ts");
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [_services_properties_service__WEBPACK_IMPORTED_MODULE_8__["PropertiesService"]],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _agm_core__WEBPACK_IMPORTED_MODULE_2__["AgmCoreModule"].forRoot({
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _menu_menu_component__WEBPACK_IMPORTED_MODULE_5__["MenuComponent"], _hotel_card_hotel_card_component__WEBPACK_IMPORTED_MODULE_7__["HotelCardComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _agm_core__WEBPACK_IMPORTED_MODULE_2__["AgmCoreModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppHotelCardHotelCardComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "HotelCardComponent", function () {
    ...
    var HotelCardComponent =
    /*#__PURE__*/
    function () {
      function HotelCardComponent() {
        _classCallCheck(this, HotelCardComponent);
      }

      _createClass(HotelCardComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    HotelCardComponent.ɵfac = function HotelCardComponent_Factory(t) {
      return new (t || HotelCardComponent)();
    };

    HotelCardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: HotelCardComponent,
      selectors: [["app-hotel-card"]],
      inputs: {
        hotel: "hotel"
      },
      decls: 17,
      vars: 10,
      consts: [[1, "container"], [1, "main-part"], [1, "image"], [3, "src"], [1, "informations"], [1, "description"], [1, "price"], [1, "btn"]],
      template: function HotelCardComponent_Template(rf, ctx) {
        if (rf & 1) {
      ...
      pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["UpperCasePipe"], _angular_common__WEBPACK_IMPORTED_MODULE_1__["CurrencyPipe"]],
      styles: [".container[_ngcontent-%COMP%] {\n    background-color: white;\n    width: 90%;\n    height: 150px;\n    padding: 15px;\n    position: fixed;\n    bottom: 0;\n}\n\n.main-part[_ngcontent-%COMP%] {\n    display: -webkit-box;\n    display: flex;\n}\n\n.image[_ngcontent-%COMP%] {\n    width: 50%;\n}\n\nimg[_ngcontent-%COMP%] {\n    height: 100px;\n}\n\n.informations[_ngcontent-%COMP%] {\n    width: 50%;\n}\n\nh1[_ngcontent-%COMP%] {\n    margin: 0;\n    font-size: 14px;\n    font-family: Arial, Helvetica, sans-serif;\n}\n\n.description[_ngcontent-%COMP%] {\n    font-size: 10px;\n    font-family: Arial, Helvetica, sans-serif;\n    color: grey;\n}\n\n.price[_ngcontent-%COMP%] {\n    font-size: 16px;\n    font-family: \"Arial Black\", Gadget, sans-serif;\n}\n\nbutton[_ngcontent-%COMP%] {\n    background-color: orange;\n    width: 100%;\n    height: 30px;\n    font-family: Arial, Helvetica, sans-serif;\n    color: white;\n    border: 0;\n}\n/*# sourceMappingURL=data:application/json;base64, */"]
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HotelCardComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppServicesPropertiesServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function () {
      ...
      _createClass(PropertiesService, [{
        key: "get",
        value: function get(latitude, longitude, type) {
          return this.http.get("https://places.sit.ls.hereapi.com/places/v1/autosuggest?at=".concat(latitude, ",").concat(longitude, "&q=").concat(type, "&apiKey=").concat(_constants_app_constants__WEBPACK_IMPORTED_MODULE_1__["AppConstants"].HERE_API_KEY));
        }
      }]);
    ...
    PropertiesService.ɵfac = function PropertiesService_Factory(t) {
      return new (t || PropertiesService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]));
    };

    PropertiesService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PropertiesService, [{
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Projects\Limehome\heroku\limehometest\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
